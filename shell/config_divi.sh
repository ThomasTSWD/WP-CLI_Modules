...
if (is_array($options)) {
    $postinfo2 = $options["divi_postinfo2"];
...
$options = get_option("et_divi");
if (is_array($options)) {
    $postinfo1 = $options["divi_postinfo1"];
...
if (is_array($options)) {
    ...
    foreach ($off_options as $option) {
     ...
     $options["custom_footer_credits"] = $options["custom_footer_credits"] = "<a href=\"/\">© <span class=\"tswd-year\">2024</span> Company </a> <a href=\"/politique-de-confidentialite/\">Politique de confidentialité</a> <a href=\"/mentions-legales/\">Mentions légales</a> <a target=\"_blank\" href=\"https://tswd.fr/\">Création <span>TSWD</span></a>";
